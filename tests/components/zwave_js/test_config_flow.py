...
@pytest.mark.parametrize(
    "discovery_info, discovery_info_side_effect, server_version_side_effect, addon_info_side_effect, abort_reason",
    [
        (
...
@pytest.mark.parametrize(
    "set_addon_options_side_effect, start_addon_side_effect, discovery_info, server_version_side_effect, abort_reason",
    [
        (
            HassioAPIError(),
            None,
